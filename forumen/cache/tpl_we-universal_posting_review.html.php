...
<?php $_post_review_row_count = (isset($this->_tpldata['post_review_row'])) ? sizeof($this->_tpldata['post_review_row']) : 0;if ($_post_review_row_count) {for ($_post_review_row_i = 0; $_post_review_row_i < $_post_review_row_count; ++$_post_review_row_i){$_post_review_row_val = &$this->_tpldata['post_review_row'][$_post_review_row_i]; if ($_post_review_row_val['S_IGNORE_POST']) {  ?>

		<div class="post bg3 post-ignore" id="review">
			<div class="inner"><span class="corners-top"><span></span></span>
				<?php echo $_post_review_row_val['L_IGNORE_POST']; ?>

	<?php } else { ?>

		<div class="post bg2<?php if ($_post_review_row_val['ONLINE_STATUS']) {  ?> online<?php } ?>" id="review">
			<div class="inner"><span class="corners-top"><span></span></span>
	<?php } ?>
