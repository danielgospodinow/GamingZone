<?php if (!defined('IN_PHPBB')) exit; ?><div class="panel">
	...
	<?php } if ($this->_rootref['S_LINK_AVATAR']) {  ?>
		...
		<dl>
			...
			<dd>
				<label for="width"><input type="text" name="width" id="width" size="3" value="<?php echo (isset($this->_rootref['AVATAR_WIDTH'])) ? $this->_rootref['AVATAR_WIDTH'] : ''; ?>" class="inputbox autowidth" /> <?php echo ((isset($this->_rootref['L_PIXEL'])) ? $this->_rootref['L_PIXEL'] : ((isset($user->lang['PIXEL'])) ? $user->lang['PIXEL'] : '{ PIXEL }')); ?></label> &times;&nbsp;
				<label for="height"><input type="text" name="height" id="height" size="3" value="<?php echo (isset($this->_rootref['AVATAR_HEIGHT'])) ? $this->_rootref['AVATAR_HEIGHT'] : ''; ?>" class="inputbox autowidth" /> <?php echo ((isset($this->_rootref['L_PIXEL'])) ? $this->_rootref['L_PIXEL'] : ((isset($user->lang['PIXEL'])) ? $user->lang['PIXEL'] : '{ PIXEL }')); ?></label>
			</dd>
		</dl>
	<?php } ?>
