...
<p><?php echo ((isset($this->_rootref['L_ACP_MOBIQUO_MOD_VER'])) ? $this->_rootref['L_ACP_MOBIQUO_MOD_VER'] : ((isset($user->lang['ACP_MOBIQUO_MOD_VER'])) ? $user->lang['ACP_MOBIQUO_MOD_VER'] : '{ ACP_MOBIQUO_MOD_VER }')); ?> <?php echo (isset($this->_rootref['MOBIQUO_MOD_VERSION'])) ? $this->_rootref['MOBIQUO_MOD_VERSION'] : ''; ?></p>
